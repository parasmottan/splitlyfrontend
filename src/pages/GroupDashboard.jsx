...
export default function GroupDashboard() {
  ...
  return (
    <div className="page page-white" style={{ display: 'flex', flexDirection: 'column', minHeight: '100dvh' }}>
      <Header title={g?.name || "Loading..."} onBack={() => navigate('/groups')} />
          ...
          <div style={{ animation: 'fadeIn 0.3s ease-out' }}>
            ...
            <div className="card" style={{ padding: '20px', margin: '8px 0 16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
                <div>
                  <Skeleton width="50px" height="13px" style={{ marginBottom: '6px' }} />
                  <Skeleton width="80px" height="24px" />
                </div>
                <div style={{ textAlign: 'right' }}>
                  <Skeleton width="70px" height="13px" style={{ marginBottom: '6px', marginLeft: 'auto' }} />
                  <Skeleton width="80px" height="24px" />
                </div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', paddingTop: '12px', borderTop: '1px solid var(--gray-100)' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', marginBottom: '20px' }}>
              <Skeleton height="48px" borderRadius="var(--radius-md)" style={{ flex: 1 }} />
              <Skeleton height="48px" borderRadius="var(--radius-md)" style={{ flex: 1 }} />
            </div>

            {/* Settings Link Skeleton */}
            <Skeleton height="48px" borderRadius="12px" style={{ marginBottom: '24px' }} />

            {/* Tab Skeleton */}
            <Skeleton height="40px" borderRadius="var(--radius-md)" style={{ marginBottom: '16px' }} />
