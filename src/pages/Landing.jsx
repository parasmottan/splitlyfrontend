...
export default function Landing() {
  ...
  return (
    <div className="page page-white" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', paddingBottom: '60px' }}>
      ...
      {/* Text */}
      <h1 style={{ fontSize: '34px', fontWeight: '800', textAlign: 'center', lineHeight: '1.15', marginBottom: '12px' }}>
        Split expenses.<br />
        <span style={{ color: 'var(--blue)' }}>Stay balanced.</span>
      </h1>
      <p style={{ fontSize: '16px', color: 'var(--text-secondary)', textAlign: 'center', lineHeight: '1.5', maxWidth: '300px', marginBottom: '60px' }}>
